...
function OrderBooks() {
    ...
    function findStrikeIndex(str) {
        ...
        console.log('find strike (converted):', numStr, typeof numStr);
        console.log('strikes and their types:');
        for (let i=0; i<streamedData.strikes.length; i++) {
            console.log('current:', streamedData.strikes[i]);
            if (streamedData.strikes[i] === numStr) return i;
        }
    }
    ...
    if (streamedData) {
        console.log('data for selectedStrike:', streamedData.obs[selectedExpiry].data[selectedStrike]);
        console.log('data:', streamedData.obs[selectedExpiry].data);
    }
